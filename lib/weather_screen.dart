...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  List<String> cities = ['Yangon', 'Mandalay', 'Taunggyi', 'Lashio', 'Bago'];
  ...
  void updateWeather(String selectedCity) {
    setState(() {
        ...
        children: [
          ...
          FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              final currentTemp = (currentWeatherData['main']['temp'] - 273.15).toStringAsFixed(1);
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          dynamic hourlyTemp =(hourlyForecast['main']['temp'] - 273.15).toStringAsFixed(1) + ' °C';
